...
public class BaseVkontakteConfig implements VkontakteConfig {
    ...
    public static class Messages implements SocialMessages {
        ...
        String linkCommandAlreadyLinked = "This account is already linked to VKontakte";
        ...
        String accountAlreadyUnlink = "You've already unlinked your VKontakte account.";
        String accountUnlinkSuccess = "You have successfully unlinked the account from VKontakte";
        String unlinkDisabled = "Account unlinking is not possible. Administration has switched off this feature";
        String accountNotLinked = "This account is in no way related to your VKontakte account";
