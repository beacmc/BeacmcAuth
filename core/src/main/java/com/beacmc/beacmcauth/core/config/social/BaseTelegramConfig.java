...
public class BaseTelegramConfig implements TelegramConfig {
    ...
    public static class Messages implements SocialMessages {
        ...
        String linkCommandAlreadyLinked = "This account is already linked to Telegram";
        ...
        String accountAlreadyUnlink = "You've already unlinked your Telegram account.";
        String accountUnlinkSuccess = "You have successfully unlinked the account from Telegram";
        String unlinkDisabled = "Account unlinking is not possible. Administration has switched off this feature";
        String accountNotLinked = "This account is in no way related to your Telegram account";
